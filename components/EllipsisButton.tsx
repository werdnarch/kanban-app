...
export default function EllipsisButton({ board }: EllipsisProps) {
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={popupRef}
        className={`bg-white absolute top-full right-4 text-sm mt-6 popup rounded-sm shadow-lg shadow-[#635fc7]/20 min-w-[100px] flex flex-col gap-4 text-left p-4 ${
      ...
      <TaskModal active={menu} setActive={setMenu} task={task} board={board} />
    </div>
  );
}
